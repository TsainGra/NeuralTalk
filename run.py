...
img = [os.path.basename(x) for x in glob.glob('Flickr8k_Dataset/*.jpg')]
...
final_model.summary()
final_model.fit_generator(data_generator(batch_size=128), steps_per_epoch=50000,
                                              nb_epoch=1,
                                              verbose=0)
