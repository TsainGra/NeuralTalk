...
3. DOWNLOAD INCEPTION MODEL FROM 'http://download.tensorflow.org/models/image/imagenet/inception-2015-12-05.tgz'
4. PASTE THE 'imagenet' FILE IN THE SAME FOLDER WHICH CONATAINS THIS SCRIPT.
